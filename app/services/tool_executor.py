...
_FALLBACK_TOOLS: List[ToolRow] = [
    ...
    ToolRow(
        id="feature_cod_toggle",
        name="feature_cod_toggle",
        display_name="Toggle COD Feature",
        description="Enable or disable Cash on Delivery (COD) for a seller company.",
        entity="seller_feature",
        intent="act",
        http_method="POST",
        endpoint_path="/api/v1/admin/sellers/enablePartialCodToggle/{company_id}",
        base_url_key="MCAPI_BASE_URL",
        auth_type="icrm_token",
        request_schema={
            "type": "object",
            "required": ["company_id", "enabled"],
            "properties": {
                "company_id": {"type": "integer", "description": "Seller company ID"},
                "enabled": {"type": "boolean", "description": "True=enable COD, False=disable COD"},
            },
        },
        risk_level="high",
        approval_mode="manual",
    ...
    ToolRow(
        id="feature_srf_enable",
        name="feature_srf_enable",
        display_name="Toggle SRF Feature",
        description="Enable or disable SRF (Shiprocket Fulfilment) feature for a seller company.",
        entity="seller_feature",
        intent="act",
        http_method="POST",
        endpoint_path="/api/v1/admin/sellers/srf-feature-enable/{company_id}",
        base_url_key="MCAPI_BASE_URL",
        auth_type="icrm_token",
        request_schema={
            "type": "object",
            ...
            "properties": {
                "company_id": {"type": "integer", "description": "Seller company ID"},
                "enabled": {"type": "boolean", "description": "True=enable SRF, False=disable SRF"},
            },
        },
        risk_level="medium",
        approval_mode="manual",
    ...
    ToolRow(
        id="analytics_ndr_count",
        name="analytics_ndr_count",
        display_name="NDR Count Analytics",
        description="Get live NDR (Non-Delivery Report) count for a company in a date range.",
        entity="ndr",
        intent="report",
        http_method="GET",
        endpoint_path="/api/v1/admin/ndr",
        base_url_key="MCAPI_BASE_URL",
        auth_type="icrm_token",
        request_schema={
            "type": "object",
            "required": ["client_id"],
            "properties": {
                "client_id": {"type": "integer", "description": "Seller company ID"},
    ...
    ToolRow(
        id="analytics_shipment_count",
        name="analytics_shipment_count",
        display_name="Shipment Count Analytics",
        description="Get live shipment count for a company in a date range.",
        entity="shipment",
        intent="report",
        http_method="GET",
        endpoint_path="/api/v1/admin/shipments",
        base_url_key="MCAPI_BASE_URL",
        auth_type="icrm_token",
        request_schema={
            "type": "object",
    ...
    ToolRow(
        id="analytics_order_count",
        name="analytics_order_count",
        display_name="Order Count Analytics",
        description="Get live order count for a company in a date range.",
        entity="order",
        intent="report",
        http_method="GET",
        endpoint_path="/api/v1/admin/orders",
        base_url_key="MCAPI_BASE_URL",
        auth_type="icrm_token",
        request_schema={
            "type": "object",
